...
def get_menu_data(url, base_url):
    ...
    menuimage = soup.select(".img_box > .img")
...
base_url = "https://m.booking.naver.com/order/bizes/1106626/items/5741772?theme=place&refererCode=menutab&area=ple"
all_tabs_data = []
...
# 데이터를 JSON 파일로 저장
with open("bbqchicken.json", "w", encoding='utf-8') as json_file:
