...
# URL 정의
url = "https://m.booking.naver.com/order/bizes/914387/items/5089135?theme=place&refererCode=menutab&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("nenechicken.json", "w", encoding='UTF-8') as json_file:
