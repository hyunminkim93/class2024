...
# URL 정의
url = "https://m.booking.naver.com/order/bizes/984365/items/5327122?theme=place&refererCode=menutab&area=pll"
chart_data = get_menu_data(url)

# 데이터를 JSON 파일로 저장
with open("bhcchicken.json", "w", encoding='UTF-8') as json_file:
